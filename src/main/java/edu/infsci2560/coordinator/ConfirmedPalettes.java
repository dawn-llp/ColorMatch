...
public List<SortedPalette> getSortedPalettes(){
								return sortedPalettes;
}

public void setSortedPalette(List<SortedPalette> sortedPalettes){
								this.sortedPalettes = sortedPalettes;
}
